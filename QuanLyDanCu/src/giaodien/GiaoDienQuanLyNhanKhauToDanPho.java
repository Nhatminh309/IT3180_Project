...
public class GiaoDienQuanLyNhanKhauToDanPho extends GiaoDienDangNhapToDanPho{
    public GiaoDienQuanLyNhanKhauToDanPho(String taiKhoan) {
        super(taiKhoan);
    ...
    public static void main(String[] args) {
        new GiaoDienQuanLyNhanKhauToDanPho("admin");
    }
}
