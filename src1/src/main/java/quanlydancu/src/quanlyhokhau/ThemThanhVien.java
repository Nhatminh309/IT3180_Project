...
import quanlydancu.src.quanlynhankhau.ThemNhanKhau;
...
public class ThemThanhVien extends ConnectDatabase {
    ...
    public ThemThanhVien() throws SQLException {
        ...
        chooseFileButton = new JButton("Tiếp tục");
        ...
        maHKField.setText(String.valueOf(maHKauto));
    ...
    public void addNKToSQL() throws SQLException {

        Connection connection = getConnectDatabase();

        try {
            Statement statement = connection.createStatement();
            ResultSet resultSet = statement.executeQuery("SELECT MAX(Ma_nhan_khau) FROM nhan_khau");
            int currentMaxId = 0;
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO nhan_khau(ma_nhan_khau, ho_va_ten, ngay_sinh, gioi_tinh, noi_sinh, " +
            ...
            preparedStatement.setString(2, hoTenField.getText());
            preparedStatement.setDate(3, Date.valueOf(dobField.getText()));
            preparedStatement.setString(4, gioiTinhField.getText());
            preparedStatement.setString(5, noiSinhField.getText());
            preparedStatement.setString(6, queQuanField.getText());
            preparedStatement.setString(7, danTocField.getText());
            preparedStatement.setString(8, tonGiaoField.getText());
            preparedStatement.setString(9, ngheNghiepField.getText());
            preparedStatement.setString(10, noiLamViecField.getText());
            preparedStatement.setDate(11, Date.valueOf(ngayDKField.getText()));
            preparedStatement.setString(12, cccdField.getText());
            preparedStatement.setString(13, sdtField.getText());
            preparedStatement.setString(14, quanHeField.getText());

            preparedStatement.setInt(15, Integer.parseInt(maHKField.getText()));
